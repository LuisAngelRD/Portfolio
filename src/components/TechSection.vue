...
const categories: TechCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Rust', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/rust/rust-original.svg', color: '#dea584' },
    ]
  },
  {
    label: 'Herramientas',
...
<template>
  <section class="section tech" ref="sectionRef">
    <h2 class="section-title">Tecnolog&iacute;as</h2>
    <p class="section-subtitle">
      Herramientas y lenguajes con los que trabajo d&iacute;a a d&iacute;a para construir soluciones de software.
    </p>
    ...
    <div class="tech__categories">
      ...
      >
        <div class="tech__category-header">
          ...
          <h3 class="tech__category-label">{{ category.label }}</h3>
        </div>
...
.tech__category:hover {
  ...
  box-shadow: 0 12px 40px rgba(79, 195, 247, 0.04);
}
...
.tech__item:hover .tech__icon-wrapper {
